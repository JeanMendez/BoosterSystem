...
<section class="content">
  ...
  <h1>Personas interesada</h1>
  <a class="btn btn-primary" download="miExcelPersonasInteresada" href="includes/miExcelPersonasInteresadas.php">Informe&nbsp; <i class="fa fa-download"></i> </a>
        <hr>
  <br>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                            <a href="asignarCitas.php?id=<?php echo $fila['idInteresados']; ?>" class="btn btn-success">Agendar</a>
                            </td>
                        </tr>
                <?php
                    }
